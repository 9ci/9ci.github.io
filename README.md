[![Build Status](https://travis-ci.org/9ci/9ci.github.io.svg?branch=source)](https://travis-ci.org/9ci/9ci.github.io)

This is the website for [9ci](https://9ci.com).

The site is built using Jekyll and Gulp with a starting point template from [Savas Labs](https://savaslabs.com) with can be found [here](https://github.com/savaslabs/savaslabs.github.io)

> Savas Labs  Copyright (C) 2017
...
- `./dock-build.sh` run this after making changes and before doing a git push. This does the gulp build and runs all the scripts to deal with assets, sass, etc to get things setup for jekyll to deploy the site. Check it all into github (this local build is for the reason, select all the files generated)
